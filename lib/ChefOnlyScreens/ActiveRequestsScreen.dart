...
class ActiveRequestsScreen extends StatefulWidget {
  const ActiveRequestsScreen({Key key, this.chefId}) : super(key: key);
  final String chefId;

  @override
  _ActiveRequestsScreenState createState() => _ActiveRequestsScreenState();
}
...
class _ActiveRequestsScreenState extends State<ActiveRequestsScreen> {
  ...
  @override
  void initState() {
    requests = ChefFunctions().getActiveRequestById(widget.chefId);
    super.initState();
  }
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          if(snapshot.data.documents.isNotEmpty) {
                ...
                child: Container(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      InProgressList(active: active, height: height, id: widget.chefId, refresh: refresh),
                      Padding(
            ...
            return PlatformScaffold(
              appBar: PlatformAppBar(title: Text('Active Requests')),
  ...
  Widget build(BuildContext context) {
    if (active.isNotEmpty) {
      ...
      return Padding(
        ...
        child: Center(child: Text('No in progress requests')),
      );
    }
  }
}
