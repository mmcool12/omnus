...
class ImageFunctions {
  ...
  final FirebaseStorage storage = FirebaseStorage(storageBucket: 'gs://titan-2a457.appspot.com');
  ...
  Future<String> uploadImage(File image, String userId) async{
    ...
    if (userId == ""){
      ...
      filePath = 'images/$userId.png';
    }
    _uploadTask = storage.ref().child(filePath).putFile(image);
    return filePath;
  }
  ...
  pickThenUploadProfile(ImageSource source, String userId) async {
    ...
    if (image != null){
      String filePath = await uploadImage(image, "");
